		...
		<div class="mt-3 mb-3 col-md-8">
			...
			<div class="border rounded mt-2 p-3">
				<form method="POST" action="">
					<input type="hidden" class="form-control" name="user_id" value="<?php echo $currentUser['user_id']; ?>">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							<input type="text" class="form-control" name="lastname" value="<?php echo $currentUser['lastname']; ?>">
						</div>
					</div>
